...
export const standConfigs: StandConfig[] = [
  {
    ...
    slots: [
      { key: "back", label: "Back", size: "LG", x: 50, y: 55, flowerHeight: 280 },
      { key: "frontLeft", label: "Front Left", size: "SM", x: 30, y: 40, flowerHeight: 200 },
      { key: "frontRight", label: "Front Right", size: "SM", x: 70, y: 40, flowerHeight: 200 },
    ],
  },
  {
    id: "triple-clear",
  ...
  },
  {
    ...
    slots: [
      { key: "left", label: "Left", size: "LG", x: 38, y: 48, flowerHeight: 260 },
      { key: "right", label: "Right", size: "SM", x: 62, y: 42, flowerHeight: 200 },
    ],
  },
  {
  ...
  },
  {
    ...
    slots: [
      { key: "center", label: "Flower", size: "LG", x: 50, y: 48, flowerHeight: 280 },
    ],
  },
  {
    id: "lg-lotus",
